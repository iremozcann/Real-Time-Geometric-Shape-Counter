...
#real-time geometric shape counter using the OpenCV library. 
#It detects the type of geometric shapes in real-time video input from a webcam and counts the number, perimeter, and area of each shape
